...
| 토큰 | 라이트 | 다크 | 용도 |
|---|---|---|---|
| `bg` | `#F6F7FB` | `#0D0F15` | 본문 배경 |
| `surface` | `#FFFFFF` | `#171922` | 카드·패널 |
| `surfaceMuted` | `#F0F2F7` | `#222530` | 비활성·보조 면·검색 입력 |
| `border` | `#DDE1EA` | `#343846` | 구분선·카드 보더 |

**텍스트 — 3단계**
| 토큰 | 라이트 | 다크 | 용도 | 대비 비고 |
|---|---|---|---|---|
| `textPrimary` | `#171923` | `#F4F5F8` | 본문 | ✅ |
| `textSecondary` | `#5E6472` | `#B6BCC8` | 보조(최다 사용) | ✅ |
| `textFaint` | `#818998` | `#858C99` | 메타·캡션 | UI 컴포넌트 기준(3:1), **본문 텍스트로 쓰지 않는다** |

**사이드바 전용** — 본문과 다른 위계. `DpAppShell`(`packages/dp_design/lib/src/shell/dp_app_shell.dart`)이
§9 셸 구조에서 배선한다.
| 토큰 | 라이트 | 다크 | 용도 |
|---|---|---|---|
| `railBg` | `#11131B` | `#090B10` | 사이드바 배경 |
| `railText` | `#F5F7FB` | `#F4F5F8` | 사이드바 활성·브랜드 |
| `railMuted` | `#B7BDCA` | `#B6BCC8` | 사이드바 비활성 항목 |
| `railFaint` | `#959DAD` | `#929AA8` | 사이드바 섹션 레이블 |
| `railActive` | `#272B3F` | `#23263B` | 사이드바 활성 배경 |
| `railBorder` | `#2A2F3C` | `#292D38` | 사이드바 내부 구분선 |

**액센트 (인디고)**
| 토큰 | 라이트 | 다크 | 용도 | 대비 비고 |
|---|---|---|---|---|
| `primary`(=accent) | `#5653E7` | `#9B99FF` | 버튼 배경·진행바(**채움 전용**) | — |
| `onPrimary` | `#FFFFFF` | `#17163D` | 채움 위 텍스트 | **다크는 반대 방향**(어두운 색, §위 참고) |
| `primaryText` | `#4338CA` | `#B9B8FF` | 링크·강조 텍스트 | ✅ |
| `primaryTextStrong` | `#312E81` | `#D8D8FF` | 12~14px 강조 텍스트 | ✅ |
| `accentSoft` | `#EEF2FF` | `#24244A` | 1차 카드 배경·뱃지 | — |
| `accentLine` | `#C7D2FE` | `#454589` | 1차 카드 보더 | — |

**시맨틱**
| 토큰 | 라이트 | 다크 | 용도 | 대비 비고 |
|---|---|---|---|---|
| `success` | `#137A48` | `#5DD39E` | 성공·해결됨 | ✅ |
| `warning` | `#9A5B00` | `#F6C177` | **진짜 경고 전용**(서비스 상태·구분용 색은 사용 금지, 위 참고) | ✅ |
| `danger` | `#C12C36` | `#FF7B84` | 에러·삭제·정지 | ✅ |

**태그**
| 토큰 | 라이트 | 다크 | 용도 |
|---|---|---|---|
| `tagBg` | `#EEF0F5` | `#262A36` | 태그 배경 |
| `tagText` | `#4F5664` | `#C3C8D2` | 태그 텍스트 |

**차트** — 현재 `primary` 한 색만 쓰던 것을 5계열로 분리
| 토큰 | 라이트 | 다크 | 용도 |
|---|---|---|---|
| `chart1` | `#2563EB` | `#77A5FF` | 데이터 계열 1(파랑) |
| `chart2` | `#C026D3` | `#E287F4` | 데이터 계열 2(자홍) |
| `chart3` | `#D97706` | `#F6B864` | 데이터 계열 3(주황) |
| `chart4` | `#0F766E` | `#4DD4C4` | 대비 계열(틸)·구분용 보조색 |
| `chart5` | `#64748B` | `#A1AAB8` | 중립 계열 |
...
**`chart1~3`은 데이터 계열 색이고 브랜드 액센트가 아니다.** `primary`(인디고)는 브랜드가,
...
| headlineSmall | 28/36 (w700) | 화면 제목 |
