...
class _BodyState extends ConsumerState<_Body> {
  static const _goals = ['JOB', 'CAREER_CHANGE', 'UPSKILL', 'SIDE_PROJECT'];
  ...
  void initState() {
    ...
    _learningGoal = _goals.contains(p.learningGoal) ? p.learningGoal : null;
    _targetTrack = _tracks.contains(p.targetTrack) ? p.targetTrack : null;
  }
